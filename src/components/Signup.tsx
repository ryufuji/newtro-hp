...
export function Signup() {
  ...
  return (
    <section
      id="signup"
      className="border-b-2 border-ink py-20 sm:py-28 text-ink relative isolate"
    ...
    >
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6">
        <WinFrame
          ...
          dotColors={["#06C755", "#0a0a0a", "#fafafa"]}
        >
          <div className="px-5 sm:px-10 py-12 sm:py-16 text-center bg-paper/95">
            <p className="font-bebas tracking-[0.4em] text-xs sm:text-sm text-ink/80">
              / FOUNDING MEMBER
            </p>
            ...
            <div className="mt-10 flex flex-col items-center gap-4">
              {hasLine ? (
                <a
                  ...
                  className="inline-flex items-center gap-3 rounded-full bg-paper text-ink px-8 py-4 font-bebas text-lg sm:text-xl tracking-[0.3em] border-2 border-ink shadow-[6px_6px_0_0_var(--color-ink)] hover:shadow-[3px_3px_0_0_var(--color-ink)] hover:translate-x-[3px] hover:translate-y-[3px] transition"
                  style={{ background: LINE_GREEN }}
                >
                  <LineIcon />
                  友だち追加
