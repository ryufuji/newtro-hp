...
export function Story() {
  ...
  return (
    <section
      id="story"
      className="relative isolate border-b-2 border-ink bg-ink text-paper py-20 sm:py-28 overflow-hidden"
    >
      ...
      <div className="relative mx-auto max-w-4xl px-5">
        ...
        <div className="mt-12 space-y-6 text-base sm:text-lg leading-[1.9]">
          <p>
            NewTiqueは、
            <br />
        ...
        <div
          className={`grid transition-all duration-500 ease-out ${
            expanded ? "grid-rows-[1fr] mt-12 opacity-100" : "grid-rows-[0fr] mt-0 opacity-0"
          }`}
        >
          <div className="overflow-hidden">
            <div className="border-t-2 border-paper/30 pt-10 space-y-7 text-sm sm:text-base leading-[2] text-paper/85">
              ...
              <p>
                NewTiqueは、その<em className="text-fintech not-italic">“最先端がすぐ過去になる瞬間”</em>に宿る、
                <br />
