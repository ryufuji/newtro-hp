...
export function Hero() {
  return (
    <section
      id="hero"
      className="relative isolate overflow-hidden border-b-2 border-ink bg-paper"
    >
      <div className="absolute inset-0 dot-grid opacity-40" aria-hidden />

      <div className="relative pt-24 sm:pt-28 pb-16 sm:pb-24 mx-auto max-w-6xl px-4 sm:px-6">
        {/* Old UI window chrome */}
        <div className="win-frame">
          <div className="win-titlebar">
            ...
            <span>NEWTIQUE.EXE — v1.0 — {LAUNCH_LABEL_EN}</span>
            <span className="ml-auto opacity-70">// SYSTEM 26.07.01</span>
          </div>

          {/* CRT content area */}
          <div className="relative scanlines noise crt-flicker overflow-hidden">
            {/* keyword cloud, top */}
            <div className="px-4 sm:px-8 pt-6 pb-3 flex flex-wrap justify-center text-ink/70">
              {KEYWORDS.map((k) => (
            ...
            <div className="px-4 sm:px-10 pb-10 pt-2 text-center">
            ...
            {/* character marquee inside the window */}
            <div className="border-y-2 border-ink/80 bg-paper/50">
              <CharacterShowcase />
            </div>

            {/* countdown / footer of window */}
            <div className="px-4 sm:px-10 pt-10 pb-12">
